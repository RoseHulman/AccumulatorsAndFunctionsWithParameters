...
def run_test_digits_in_power():
    ...
    #Test 1
    expected = 19
    actual = digits_in_power(5, 6)
    print('Test 1 expected', expected)
    print('         actual', actual)

    #Test 2
    expected = 22
    actual = digits_in_power(4, 7)
    print('Test 2 expected', expected)
    print('         actual', actual)

    #Test 3
    expected = 8
    actual = digits_in_power(2, 9)
    print('Test 3 expected', expected)
    print('         actual', actual)
...
def run_test_fancy_sums_of_digits():
    ...
    #Test 2
    expected = 1
    actual = fancy_sums_of_digits(100)
    print('Test 2 expected', expected)
    print('         actual', actual)

    #Test 3
    expected = 1
    actual = fancy_sums_of_digits(1000)
    print('Test 3 expected', expected)
    print('         actual', actual)
    # ------------------------------------------------------------------
